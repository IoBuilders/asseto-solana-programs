...
/// On-chain marker created when a specific token account is frozen at the CMTAT level.
...
impl FrozenBalance {
    pub const LEN: usize = 8 + 8 + 1; // discriminator + balance + bump
}
