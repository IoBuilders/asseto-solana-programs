...
pub mod cmtat_metadata_update {
    ...
    pub fn update_metadata_field(
        ...
        instructions::update_metadata::update_metadata_field(ctx, key, value)
    }
    ...
    pub fn remove_metadata_field(
        ...
        instructions::remove_metadata::remove_metadata_field(ctx, key, idempotent)
    }
}
