...
/// Hardcoded — kept in sync manually with cmtat-deploy's declare_id!.
...
/// cmtat-bond program ID. Sourced from `cmtat_bond::ID`.
pub use cmtat_bond::ID as CMTAT_BOND_PROGRAM_ID;

/// cmtat-coupon program ID. Sourced from `cmtat_coupon::ID`.
pub use cmtat_coupon::ID as CMTAT_COUPON_PROGRAM_ID;

/// cmtat-snapshot program ID. Sourced from `cmtat_snapshot::ID`.
