...
pub fn snapshot_holderbalance_seeds<'info>(mint: &'info Pubkey, holder_token_account: &'info Pubkey) -> Vec<&'info [u8]> {
    vec![SNAPSHOT_HOLDERBALANCE, mint.as_ref(), holder_token_account.as_ref()]
}
