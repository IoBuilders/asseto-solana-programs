...
/// Program ID of deploy — the program that owns mint_owner_pda accounts.
/// Cannot use `pub use deploy::ID` because deploy depends on mint
...
/// To update: change declare_id! in snapshot/src/lib.rs and Anchor.toml.
pub use snapshot::ID as SNAPSHOT_PROGRAM_ID;

/// Sourced directly from the transfer-control crate — single source of truth.
/// To update: change declare_id! in transfer-control/src/lib.rs and Anchor.toml.
