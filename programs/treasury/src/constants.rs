...
/// deploy program ID.
/// Hardcoded — kept in sync manually with deploy's declare_id!.
...
/// bond program ID. Sourced from `bond::ID`.
pub use bond::ID as BOND_PROGRAM_ID;

/// coupon program ID. Sourced from `coupon::ID`.
pub use coupon::ID as COUPON_PROGRAM_ID;

/// snapshot program ID. Sourced from `snapshot::ID`.
