...
import { CmtatMetadataUpdate } from "../target/types/cmtat_metadata_update";
...
// ── Program IDs sourced from workspace (mirrors constants.rs in cmtat-deploy) ──
const mintProgram           = anchor.workspace.CmtatMint           as Program<any>;
const metadataUpdateProgram = anchor.workspace.CmtatMetadataUpdate as Program<CmtatMetadataUpdate>;
...
describe("cmtat-deploy", () => {
  ...
  const program = anchor.workspace.CmtatDeploy as Program<CmtatDeploy>;
