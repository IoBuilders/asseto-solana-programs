...
describe("cmtat-snapshot", () => {
  ...
  // ────────────────────────────────────────────────────────────────────────────
  // `take_snapshot` is auxiliary: only callable via CPI from cmtat-coupon, with
  ...
  it("take_snapshot: rejects direct invocation with Unauthorized (auxiliary, only callable via cmtat-coupon CPI)", async () => {
