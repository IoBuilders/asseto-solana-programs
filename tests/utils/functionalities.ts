...
export const SNAPSHOT_TAKE_SNAPSHOT = 14;
export const SNAPSHOT_UPDATE_TOTALSUPPLY_SNAPSHOT = 15;
export const SNAPSHOT_UPDATE_HOLDERBALANCE_SNAPSHOT = 16;
export const TRANSFER_TRANSFER = 17;
export const TRANSFER_VERIFY_TRANSFER = 18;
export const TRANSFER_CONTROL_SET_MODES = 19;
export const TRANSFER_CONTROL_ADD_TO_WHITELIST = 20;
export const TRANSFER_CONTROL_REMOVE_FROM_WHITELIST = 21;
export const TRANSFER_HOOK_INITIALIZE_EXTRA_ACCOUNT_META_LIST = 22;
export const TRANSFER_HOOK_EXECUTE = 23;
export const TREASURY_SET_PAYMENT_TOKEN = 24;
export const TREASURY_PAY_COUPON = 25;
